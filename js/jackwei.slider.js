    ...
    JackWeiSlider.prototype = {
        init: function () {
            ...
            $element.append('<div style="width:' + settings.width + ';">\n' +
                ...
                '            <img class="jws-handle" src="../image/raduis.png">\n' +
                '            <div id="jws-1" class="jws-text"></div>\n' +
                '        </div>\n' +
                '    </div>'
            );
        ...
        move: function (offset) {
            ...
            if (!this.isCustomText)
                $element.find('.jws-text').text(Math.round(this.progress * 200) + "Mbps");
        },
